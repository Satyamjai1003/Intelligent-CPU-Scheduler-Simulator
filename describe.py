...
from streamlit_extras.add_vertical_space import add_vertical_space  #to add extra space between widgets (like buttons, text, or charts).
...
ALGORITHM_INFO = {
    "FCFS": {
        ...
        "cons": ["Poor performance for short processes", "Not optimal for average waiting time"],   #the order they arrive, each process has to wait for all the earlier processes to finish. So, the waiting time for each process tends to increase, especially for the ones that arrive later.
